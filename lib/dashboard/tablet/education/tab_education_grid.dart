...
class EducationGridTab extends StatelessWidget {
  const EducationGridTab({super.key});
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: screenWidth * 0.016, // Adjusted font size
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: Colors.white,
                            fontSize: screenWidth * 0.014, // Adjusted font size
                            letterSpacing: 1,
                          ),
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
